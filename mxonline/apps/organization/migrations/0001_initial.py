# -*- coding: utf-8 -*-
# Generated by Django 1.11.10 on 2019-02-16 12:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(max_length=150, verbose_name='\u673a\u6784\u5730\u5740')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_position', models.CharField(max_length=50, verbose_name='\u516c\u53f8\u4f4d\u7f6e')),
                ('points', models.CharField(max_length=50, verbose_name='\u516c\u53f8\u804c\u4f4d')),
                ('click', models.IntegerField(default=0, verbose_name='\u70b9\u51fb\u6570')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='\u6536\u85cf\u6570')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
                ('org', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='organization.CoursesOrg', verbose_name='\u6240\u5728\u673a\u6784')),
            ],
            options={
                'verbose_name': '\u6559\u5e08',
